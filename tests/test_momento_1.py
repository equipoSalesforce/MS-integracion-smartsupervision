...
class TestMomento1Pipeline(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        # 3. Datos simulados de la API de la SFC (Momento 1)
        ...
        # 4. Datos simulados de listado de adjuntos
    ...
    async def test_flujo_completo_momento_1_exitoso(self):
        ...
        # Mock de consulta a la Base de Datos
        ...
        # 1. Comprobamos que el servicio haya consultado y llamado a los endpoints correctos
        ...
        self.assertEqual(self.db_mock.add.call_count, 1)  # Se agregó la queja nueva
