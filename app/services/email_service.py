...
class EmailAlertService:
    ...
    # =========================================================================
    # 🔴 FIX (hallazgo de revisión externa, 2026-08-26, ronda 4 -- X5/Y4): este
    # notificador (`notificar_conflicto_operacion_cola`) se retiró junto con
    # QUEUE_OPERATION_CONFLICT -- ver QueueService.encolar_despacho. El índice de
    # cola ahora está particionado por operación ("una obligación pendiente = un
    # slot en cola"), así que dos categorías de operación para el mismo
    # Smart_Code__c ya no compiten por el mismo slot y el conflicto que esta
    # alerta reportaba no puede volver a ocurrir.